...
GOPATH=/Users/dogukanaydogdu/go
...
alias run-email="./deployer.sh run --project='honeybadger gachapon email_service'"
alias w-berlin="curl https://wttr.in/Berlin"
...
s3Files() {
aws s3 ls s3://$1 --recursive --human-readable --summarize --endpoint-url=http://localhost:4566
}

s3Get() {
aws  s3api get-object --bucket $1 --key $2 ./s3-exports/$3 --endpoint-url=http://localhost:4566
}
...
alias helpers='cd /Users/dogukanaydogdu/Documents/helpers'
